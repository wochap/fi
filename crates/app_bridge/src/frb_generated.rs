...
fn wire__crate__api__collections__export_all_json_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::models::BridgeError>(
                    (move || async move {
                        let output_ok = crate::api::collections::export_all_json().await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__collections__export_collection_csv_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "export_collection_csv",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::models::BridgeError>(
                    (move || async move {
                        let output_ok =
                            crate::api::collections::export_collection_csv(api_id).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__collections__export_collections_json_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "export_collections_json",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::models::BridgeError>(
                    (move || async move {
                        let output_ok =
                            crate::api::collections::export_collections_json(api_ids).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__collections__import_collection_csv_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "import_collection_csv",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::models::BridgeError>(
                    (move || async move {
                        let output_ok = crate::api::collections::import_collection_csv(
                            api_collection_id,
                            api_text,
                        )
                        .await?;
...
fn wire__crate__api__collections__import_collections_json_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "import_collections_json",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::models::BridgeError>(
                    (move || async move {
                        let output_ok =
                            crate::api::collections::import_collections_json(api_text).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
impl SseDecode for crate::api::models::ImportOutcomeDto {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_imported = <bool>::sse_decode(deserializer);
        let mut var_recordCount = <u32>::sse_decode(deserializer);
        let mut var_collectionIds = <Vec<String>>::sse_decode(deserializer);
        let mut var_row = <Option<u32>>::sse_decode(deserializer);
        let mut var_column = <Option<String>>::sse_decode(deserializer);
        let mut var_collectionIndex = <Option<u32>>::sse_decode(deserializer);
        let mut var_item = <Option<String>>::sse_decode(deserializer);
        let mut var_reason = <Option<String>>::sse_decode(deserializer);
        let mut var_message = <String>::sse_decode(deserializer);
        return crate::api::models::ImportOutcomeDto {
            imported: var_imported,
            record_count: var_recordCount,
            collection_ids: var_collectionIds,
            row: var_row,
            column: var_column,
            collection_index: var_collectionIndex,
            item: var_item,
            reason: var_reason,
            message: var_message,
        };
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::models::ImportOutcomeDto {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.collection_index.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::models::ImportOutcomeDto
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::models::ImportOutcomeDto>
    for crate::api::models::ImportOutcomeDto
{
    fn into_into_dart(self) -> crate::api::models::ImportOutcomeDto {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::models::ImportOutcomeDto {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <bool>::sse_encode(self.imported, serializer);
        <u32>::sse_encode(self.record_count, serializer);
        <Vec<String>>::sse_encode(self.collection_ids, serializer);
        <Option<u32>>::sse_encode(self.row, serializer);
        <Option<String>>::sse_encode(self.column, serializer);
        <Option<u32>>::sse_encode(self.collection_index, serializer);
        <Option<String>>::sse_encode(self.item, serializer);
