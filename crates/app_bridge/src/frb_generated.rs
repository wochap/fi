...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        28 => wire__crate__api__lifecycle__init_app_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__lifecycle__initialize_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__lifecycle__initialize_android_networked_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__crate__api__lifecycle__initialize_desktop_networked_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        34 => wire__crate__api__queries__list_query_definitions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        35 => wire__crate__api__collections__list_records_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__widgets__list_widget_descriptors_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
